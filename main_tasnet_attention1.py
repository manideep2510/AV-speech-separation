...
wandb.init(name='tdavss_BahdhanauNew_L2Norm', notes='Bahdhanau New Implementation, L2 Norm,Batch = 6, 25K training folders. TasNet with Resnet without LSTM Lipnet.', project="av-speech-seperation", dir='/data/AV-speech-separation1/wandb')
...
path = 'tdavss_BahdhanauNew_L2Norm_epochs40_5lr1e-4_exp1'
