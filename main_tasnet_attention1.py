...
from dataloaders import DataGenerator_val_samples_attention, DataGenerator_train_samples_attention, DataGenerator_val_unsync_attention, DataGenerator_train_unsync_attention
import random
...
wandb.init(name='tdavss_BahdhanauNew_InitialStateBahdhanau', notes='Bahdhanau New Implementation, Initial States for GRU is with Fixed numpy random seed of 100,Batch = 6, 25K training folders. TasNet with Resnet without LSTM Lipnet.', project="av-speech-seperation", dir='/data/AV-speech-separation1/wandb')
...
path = 'tdavss_BahdhanauNew_InitialStateBahdhanau_epochs40_5lr1e-4_exp1'
