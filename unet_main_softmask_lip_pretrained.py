...
model = VideoModel(256,96,(257,500,2),(125,50,100,3)).FullModel(lipnet_pretrained = 'pretrain', unet_pretrained = None)
...
path = 'lip_only_236kTrain_1to3ratio_epochs20_lr1e-4_0.1decay10epochs'
