...
from models.tdavss import TasNet
from gans.nets1 import Generator
...
folders_list_val = folders_list_val[:]
...
generator.load_weights(
    '/data/models/tdavss_LSGAN_L1Loss_BestVidEmbed_2speakers_from35/generator-40-10.2897.tf')
print('Generator weights loaded')

#tdavss_LSGAN_BestVidEmbed_256Filters_0.001LR_2speakers_from54
...
generator.load_weights(
    '/data/models/tdavss_baseline_BestVidEmbed_3speakers_from27/weights-11--8.7166.tf')
print('Model weights loaded')'''

#tdavss_baseline_BestVidEmbed_0.001LR_2speakers_from19
...
path = 'tdavss_LSGAN_L1Loss_BestVidEmbed_2speakers'

try:
    os.mkdir('/data/metric_results/' + path)
except OSError:
    pass

np.savetxt('/data/metric_results/' + path + '/pesq_val.txt', pesqs)
np.savetxt('/data/metric_results/' + path + '/sdr_val.txt', sdrs)
np.savetxt('/data/metric_results/' + path + '/snr_val.txt', snrs)
np.savetxt('/data/metric_results/' + path + '/pesq_mix.txt', pesqs_mix)
np.savetxt('/data/metric_results/' + path + '/sdr_mix.txt', sdrs_mix)
np.savetxt('/data/metric_results/' + path + '/snr_mix.txt', snrs_mix)
