...
class TasNet(object):
    ...
    def build(self):
        ...
        if self.attention == True:
            ...
            self.attn_out, self.attn_states = self.attn_layer([self.outa, self.q], verbose=False)
            print('attn_out:', self.attn_out.shape)
            print('attn_states:', self.attn_states.shape)

            
            self.fusion=concatenate([self.attn_out, self.outv],axis=-1)  # B, 200, 512
        ...
        self.mask = Activation('relu', name='mask1')(self.mask)
