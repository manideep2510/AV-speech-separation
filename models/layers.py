...
class Attention(Layer):
    ...
    def call(self, inputs):
        ...
        if 'dot' in self.score_function:                                                            # Dot Score Function
            ...
            #print('attention_score', attention_score.numpy())
        ...
        attention_weights = Activation('softmax')(K.squeeze(attention_score, axis=-1)) # (B, S*, 1)
        ...
        context_vector = K.sum(source_hidden_states * attention_weights,axis=1)                                   # (B, S*, H)
