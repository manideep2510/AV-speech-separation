...
class TasNet(object):
    ...
    def build(self):
        ...
        self.audio_input_data=Input(shape=(80000,1),dtype='float32')#audio_shape=(80000,1)
        ...
        self.decode=Conv2DTranspose(1,(16,1),strides=(8,1),padding='same',data_format='channels_last')(self.decode)
