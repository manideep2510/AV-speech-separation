...
def train_step(inputs, target, generator, discriminator, generator_optimizer, discriminator_optimizer, 
    ...
    def gradient_penalty(inputs, target, noise_inp, gen_output, discriminator, center=0):
        ...
        with tf.GradientTape() as tape:
            ...
            d_hat = discriminator([inputs[1], interpolates, noise_inp], training=True)
    ...
    with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
        ...
        disc_real_output = discriminator([inputs[1], target, noise_inp1], training=True)
        disc_generated_output = discriminator([inputs[1], gen_output, noise_inp2], training=True)
