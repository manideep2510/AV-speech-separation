...
def train_step(inputs, target, generator, discriminator, generator_optimizer, discriminator_optimizer, 
    ...
    with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
        ...
        if gan_type == 'LSGAN':
            ...
            disc_loss, disc_real_loss, disc_fake_loss, gradient_penalty = discriminator_loss_LSGAN_GP(disc_real_output, disc_generated_output, gradient_pen, 100)
...
def fit(folders_list_train, folders_list_val, folders_list_test, generator, discriminator, generator_optimizer, 
    ...
    for epoch in range(epochs):
        ...
        for n, (inputs, target) in enumerate(DataGenerator_train(folders_list_train, batch_size=batch_size, norm=1950.0, epoch=epoch+epoch_start)):
