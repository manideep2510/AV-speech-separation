...
from nets1 import Generator, Discriminator
...
wandb.init(name='tdavss_LSGAN_L1Loss_GP100_BestVidEmbed_2speakers', notes='Negartive SNR Loss, BS=8, PhaseShuffle=2, LAMBDA=100 to 0.1, LSGAN with Instance Noise for 10 epochs, Lr(D) = Lr(G)',
...
path = 'tdavss_LSGAN_L1Loss_GP100_BestVidEmbed_2speakers'
...
# Training
try:
    fit(folders_list_train, folders_list_val, folders_list_test, batch_size=batch_size,
