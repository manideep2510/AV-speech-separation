...
def cross_entropy_loss(target_mask, ground_truth_mask):

	tbm_cross_entropy = (tf.nn.sigmoid_cross_entropy_with_logits(labels=target_mask, logits=ground_truth_mask)) 
